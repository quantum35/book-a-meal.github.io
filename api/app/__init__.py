...
def create_app(config_filename):
    ...
    api.add_resource(MealLists, '/api/v2/meals', '/api/v2/meals/')
    api.add_resource(MenuOptions, '/api/v2/menu/<int:id>')
    api.add_resource(MenuList, '/api/v2/menu', '/api/v2/meals/')
    api.add_resource(Orders,  '/api/v2/orders/<int:id>')
    api.add_resource(OrderLists, '/api/v2/orders', '/api/v2/orders/')
